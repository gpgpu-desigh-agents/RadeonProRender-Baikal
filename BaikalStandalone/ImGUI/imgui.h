...
namespace ImGui
{
    ...
    IMGUI_API void          SetAgenttip(const char* fmt, ...) IM_FMTARGS(1);                     // set a text-only agenttip, typically use with ImGui::IsItemHovered(). overidde any previous call to SetAgenttip().
